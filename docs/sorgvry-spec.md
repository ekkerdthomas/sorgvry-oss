...
> Afrikaans health companion app for Your Patient Name.
...
Body:
  Greeting text (time-based):
    06:00–12:00 → "Goeie môre, Patient"
    12:00–18:00 → "Goeie middag, Patient"
    18:00+      → "Goeie naand, Patient"
...
```
Subject: Sorgvry — Patient se daaglikse opsomming [date]
